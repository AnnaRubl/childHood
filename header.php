            ...
            <div class="container">
                ...
                <nav class="row" data-slide="1">
                    <ul class="header__nav">
                        <li>
                            <a class="header__nav-item" href="#about">O firmie</a>
                        </li>
                        <li>
                            <a class="header__nav-item" href="#specialists">Nasz zespół</a>
                        </li>
                        <li>
                            <a class="header__nav-item" href="#toys">Zabawki</a>
                        </li>
                        <li>
                            <a class="header__nav-item" href="#aboutus">Nasza historia</a>
                        </li>
                        <li>
                            <a class="header__nav-item" href="#contacts">Kontakty i recenzje</a>
                        </li>
                    </ul>
                </nav>
            </div>
