...
?>
                ...
                <ul class="glide__slides">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 class="slider__title">Spełnianie dziecięcych marzeń</h2>
                    ...
                    <li style="background-image: url('<?php echo bloginfo("template_url"); ?>/assets/img/bg_2.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 style="color: #fff" class="slider__title">Prezenty dla dzieci i rodziców</h2>
                                    <a href="#" class="button">Dowiedz się więcej</a>
                                </div>
                                <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
                                    <svg width="15" height="25" viewBox="0 0 15 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li style="background-image: url('<?php echo bloginfo("template_url"); ?>/assets/img/bg_3.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2  class="slider__title">Przyjaciel, który jest zawsze przy Tobie</h2>
                                    <a href="#" class="button">Dowiedz się więcej</a>
                                </div>
                                <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
                                    <svg width="15" height="25" viewBox="0 0 15 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title">Nasz zespół</div>
                <div class="row">
        ...
        <div class="toys" id="toys">
            <div class="container">
                <h2 class="subtitle">Miękkie zabawki</h2>
                <div class="toys__wrapper">
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo("template_url"); ?>/assets/img/toy_1.jpg)">
                        <div class="toys__item-info">
                            <div class="toys__item-title">Misie</div>
                            <div class="toys__item-descr">
                                Klasyka. Każde dziecko powinno je mieć!   
                            </div>
                            <div class="minibutton toys__trigger">Więcej szczegółów</div>
                        </div>
                    </div>

                    <div class="toys__item" style="background-image: url(<?php echo bloginfo("template_url"); ?>/assets/img/toy_2.jpg)">
                        <div class="toys__item-info">
                            <div class="toys__item-title">Sówka</div>
                            <div class="toys__item-descr">
                                Chcesz, żeby Twoje dziecko było chronione nawet w nocy? Kup mu sówkę!
                            </div>
                            <div class="minibutton toys__trigger">Więcej szczegółów</div>
                        </div>
                    </div>
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo("template_url"); ?>/assets/img/toy_3.jpg)">
                        <div class="toys__item-info">
                            <div class="toys__item-title">Króliki</div>
                            <div class="toys__item-descr">
                                Króliki są różne... Ale wszystkie są wyjątkowo urocze!
                            </div>
                            <div class="minibutton toys__trigger">Więcej szczegółów</div>
                        </div>
                    </div>
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo("template_url"); ?>/assets/img/toy_4.jpg)">
                        <div class="toys__item-info">
                            <div class="toys__item-title">Giętki</div>
                            <div class="toys__item-descr">
                                Swoją drogą mamy duży wybór zabawek, których pozę wybiera samo dziecko. (Trwałe. Nogi i ręce nie odłamują się)
                            </div>
                            <div class="minibutton toys__trigger">Więcej szczegółów</div>
                        </div>
                    </div>
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo("template_url"); ?>/assets/img/toy_5.jpg)">
                        <div class="toys__item-info">
                            <div class="toys__item-title">Postacie</div>
                            <div class="toys__item-descr">
                                Twoje dziecko szaleje za postacią z kreskówek? Podążamy za wszystkimi trendami i mamy przyjemność zaoferować zarówno te najnowocześniejsze, jak i postacie „z naszego dzieciństwa”
                            </div>
                            <div class="minibutton toys__trigger">Więcej szczegółów</div>
                        </div>
                    </div>
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo("template_url"); ?>/assets/img/toy_6.jpg)">
                        <div class="toys__item-info">
                            <div class="toys__item-title">Unikalne</div>
                            <div class="toys__item-descr">
                                Chcesz, żeby wszyscy zazdrościli Twojemu dziecku? Podaruj zabawki własnej produkcji! Są wyjątkowe, a Twoje dziecko będzie dumnym posiadaczem ekskluzywnego egzemplarza!
                            </div>
                            <div class="minibutton toys__trigger">Więcej szczegółów</div>
                        </div>
                    </div>
                ...
                <h2 class="subtitle">Zabawki edukacyjne</h2>
                <div class="toys__wrapper">

                    <div class="toys__item" style="background-image: url(<?php echo bloginfo("template_url"); ?>/assets/img/toy_7.jpg)">
                        <div class="toys__item-info">
                            <div class="toys__item-title">Latawiec</div>
                            <div class="toys__item-descr">
                                Kto w dzieciństwie nie chciał nauczyć się latać? A latawiec pomoże złapać wiatr i przenieść wszystkie Twoje zmartwienia daleko, daleko...
                            </div>
                            <div class="minibutton toys__trigger">Więcej szczegółów</div>
                        </div>
                    </div>
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo("template_url"); ?>/assets/img/toy_8.jpg)">
                        <div class="toys__item-info">
                            <div class="toys__item-title">Muzyczne</div>
                            <div class="toys__item-descr">
                                Spróbuj zainteresować swoje dziecko muzyką! Być może kryje się w nim przyszłość Jareda Leto!
                            </div>
                            <div class="minibutton toys__trigger">Więcej szczegółów</div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('looking_title', 2); ?></span> <?php the_field('looking_descr', 2); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('desires_title', 2); ?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('desires_descr', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php 
                                $image = get_field('desires_img'); 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('quality_title', 2); ?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('quality_descr', 2); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('technologies_title', 2); ?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('technologies_descr', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php 
                                $image = get_field('technologies_img'); 
        ...
        <div class="contacts" id="contacts">
            <h1 class="title">Gdzie nas znaleźć</h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            <?php the_field('location_details', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div id="map" class="contacts__map">
                            <?php echo do_shortcode( '[yamap center="'. get_field('first_coordinate') . ',' .get_field('second_coordinate') . '" height="100%" controls="" zomm="12" type="yandex#map" mobiledrag="0"][yaplacemark name="Our shop" coord="'. get_field('first_coordinate') . ',' . get_field('second_coordinate') . '" icon="islands#dotIcon" color="#1e98ff"][/yamap]');?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Skontaktuj się z nami</div>
                        <div class="contacts__info">
                            ...
                            <div class="contacts__mail">
                                Lub napisz do nas na e-mail
                                <a href="<?php the_field('mail', 2) ?>" class="contacts-mail"><?php the_field('mail', 2) ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Zostaw swoją opinię</div>
                        <form action="#" class="contacts__feed">
                            ...
                            <label for="feedtext">
                                Twoja recenzja <span>*</span>
                            </label>
                            <textarea required name="feedtext" id="feedtext"></textarea>
                            <button class="minibutton">Wysłać</button>
                                ...
                                <ul class="glide__slides">
                                    <li class="glide__slide">
                                        ...
                                        <div class="feedslider__text">
                                            Dziękuję bardzo za życzliwość i cierpliwość. Właśnie przyszłem do Ciebie z pomysłem na prezent, a Ty zamieniłaś go w pełnoprawny projekt! Więc mój syn bawi się teraz całą dobę pociągiem zbudowanym według jego rysunków)
                                            <br><br>
                                            Szczególne podziękowania dla menadżerki Margarity za jej cierpliwość i wytrwałość!
                                        </div>
                                    </li>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                            Agnieszka Kaliwoszka
                                        </div>
                                        <div class="feedslider__text">
                                            Zamówiłam od chłopaków całą partię zabawek do przedszkola. Nowy Rok rozpoczął się z hukiem! Teraz wszystkie dzieci są szczęśliwe i nie rozstają się ze swoimi prezentami, a najbardziej przebiegłe pytają, kiedy będą następne wakacje)
                                        </div>
                                    </li>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                        ...
                                        <div class="feedslider__text">
                                            Postanowiłam zamówić tutaj prezenty na urodziny mojego dziecka. I wcale tego nie żałuję! Miś jest dokładnie taki jakiego chciałam, taki jaki miałam w dzieciństwie: mięciutki, przyjemny w dotyku i bardzo uroczy. Od razu widać, że jest wykonany ręcznie.
                                        </div>
                                    </li>
                                </ul>
                            </div>
