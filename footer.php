<div class="question">
            <div class="question__text">
                Jakiekolwiek pytania? Napisz do nas!
            </div>
            <div id="reply" class="minibutton">Napisać</div>
            ...
            <div class="reply__body">
                ...
                <form action="#">
                    ...
                    <div class="reply__wrapper">
                        ...
                        <div>
                            <label for="phone">Twój telefon <span>*</span></label>
                            <input name="phone" id="phone" type="tel" required>
                        </div>
                    </div>
                    <label for="text">Twoje pytanie <span>*</span></label>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <div class="footer__social-item">
                                    <?php 
                                      $image = get_field('instagram_icon'); 
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            ...
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo("template_url"); ?>/assets/img/icons/svg/pointer.svg" alt="wskaźnik" class="footer__contacts-logo">
